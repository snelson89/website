...
- **Nelson, S.** (2023). Unordered rules that only apply to the input are not more complex than ordered rules. M100. Massachusetts Institute of Technology. Cambridge, MA, USA.
